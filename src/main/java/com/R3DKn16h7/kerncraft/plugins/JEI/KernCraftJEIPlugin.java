...
import com.R3DKn16h7.kerncraft.tileentities.ExtractorBlockEntity;
...
//        subtypeRegistry.useNbtForSubtypes(KernCraftItems.CANISTER);
    ...
    public void register(IModRegistry registry) {
        ...
        registry.addRecipeCategoryCraftingItem(new ItemStack(Item.getItemFromBlock(KernCraftTileEntities.EXTRACTOR)),
        ...
        if(KernCraft.MOD_CONFIG_DISPLAY_ALL_ELEMENTS) {
            for (int i = 1; i <= ElementBase.NUMBER_OF_ELEMENTS; ++i) {
                ...
                if(descr != null) {
                    registry.addDescription(KernCraftItems.CANISTER.getElementItemStack(i), descr);
                }
            }
        }
