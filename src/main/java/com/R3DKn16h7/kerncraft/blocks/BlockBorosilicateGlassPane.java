 ...
 */
public class BlockBorosilicateGlassPane extends BasicBlock {
    ...
    public final boolean canPaneConnectToBlock(Block blockIn) {
        return blockIn.getDefaultState().isFullCube() || blockIn == this || blockIn == Blocks.GLASS || blockIn == Blocks.STAINED_GLASS || blockIn == Blocks.STAINED_GLASS_PANE || blockIn instanceof net.minecraft.block.BlockPane;
    }
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing) {
        ...
        return connector instanceof net.minecraft.block.BlockPane;
    }
